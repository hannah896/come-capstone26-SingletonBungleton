...
/// </summary>
public class StoryGenerator : IGraphPipelineStage
{
    ...
    public void Initialize(WorldSettings settings)
    {
        ...
        _prng = new System.Random(settings.WorldSeed + (int)WorldSeedChannel.StoryGenerator);   // 101
    }
    /// <summary>
    ...
    private Node PickParentNode()
    {
        ...
        switch (_worldSettings.WorldBranch)
        {
            ...
            default:
                return candidates[_prng.Next(0, candidates.Count)];
    ...
    private async UniTask<bool> TryProcessNextRegionAsync(List<RegionData> candidateRegions)
    {
        ...
        // 2. 랜덤 선택
        var selectedRegion = unlockableRegions[_prng.Next(0, unlockableRegions.Count)];
